...
/* Меню - иконка "гамбургер" */
    ...
    flex-wrap: wrap;
    gap: 7px;
    margin-top: -11px; /* Поднимаем элемент вверх */
    margin-bottom: 5px;
    padding-bottom: 10px;
    border-bottom: 1px solid #e1e4e8;
}
